...
本项目同时提供 `CITATION.cff` 标准引用文件（GitHub / Zenodo 双平台自动识别）。最终提交包中的公开引用信息见本赛道根目录 [README.md](../README.md)。
...
本数据集采用 **Creative Commons Attribution 4.0 International (CC-BY-4.0)** 许可。详见本赛道提交包根目录 [LICENSE](../LICENSE) 或访问 [https://creativecommons.org/licenses/by/4.0/](https://creativecommons.org/licenses/by/4.0/)。
